...
module LevelScalingSettings
  ...
  DIFFICULTIES = {
    1 => Difficulty.new(fixed_increase: -1, random_increase: 0),  # Trainer
    2 => Difficulty.new(fixed_increase: -2, random_increase: 2),  # Wild encounters
    3 => Difficulty.new(fixed_increase: 0, random_increase: 0),   # Strong Wild Encounters
