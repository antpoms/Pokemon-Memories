...
BANVAR=35
BORW=71
Blacklist=[[],[:BATONPASS,:BELLYDRUM,:CALMMIND,:COTTONGUARD,:DRAGONDANCE,:SHELLSMASH,:SHIFTGEAR,:SPIKES,:SPORE,:STEALTHROCK,:SWORDSDANCE,:TOXIC,:TRICKROOM,:AURORAVEIL,:AGILITY,:QUIVERDANCE,60],[:SHELLSMASH,:QUIVERDANCE,100],[]]
